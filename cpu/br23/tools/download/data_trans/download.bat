...
..\..\isd_download.exe  ..\..\isd_config.ini -tonorflash -dev br23 -boot 0x12000 -div8 -wait 300 -uboot ..\..\uboot.boot -app ..\..\app.bin ..\..\cfg_tool.bin -ota_file ..\..\ota_all.bin -flash-params flash_params.bin 
:: -format all
::-reboot 2500

...
static const u8 sdp_a2dp_sink_service_data[] = {
    0x35, 0x4E,
    0x09, 0x00, 0x00,
    0x0A, 0x00, 0x01, 0x00, 0x05,
    0x09, 0x00, 0x01,
    0x35, 0x03,
    0x19, 0x11, 0x0B,
    0x09, 0x00, 0x04,
...
SDP_RECORD_HANDLER_REGISTER(a2dp_sdp_record_item) = {
    .service_record = (u8 *)sdp_a2dp_sink_service_data,
    .service_record_handle = 0x00010005,
};
#endif

#if (USER_SUPPORT_PROFILE_AVCTP==1)
u8 avctp_profile_support = 1;
static const u8 sdp_avrcp_target_service_data[] = {
    0x35, 0x69,
    0x09, 0x00, 0x00,
    0x0A, 0x00, 0x01, 0x00, 0x06,
    0x09, 0x00, 0x01,
    0x35, 0x06,
    0x19, 0x11, 0x0C,
    0x19, 0x12, 0x03,
    ...
    0x09, 0x01, 0x00,
    0x25, 0x0C,
    'A', 'V', 'R', 'C', 'P', ' ', 'T', 'a', 'r', 'g', 'e', 't',
    0x09, 0x03, 0x11,
    0x09, 0x00, 0x03,
};

SDP_RECORD_HANDLER_REGISTER(avrcp_sdp_record_item) = {
    .service_record = (u8 *)sdp_avrcp_target_service_data,
